...
JOYSTICK_COMMAND = "roslaunch steering_control steering_control.launch veh:={veh}"
BRANCH = "daffy"
GUI_ARCH = "amd64"
ARCH = "arm64v7"   #might be arm64v7
GUI_DEFAULT_IMAGE = "duckietown/dt-gui-tools:" + BRANCH + "-" + ARCH
CLI_DEFAULT_IMAGE = "duckietown/dt-gui-tools:steering_control2"
#CLI_DEFAULT_IMAGE = "wheel_joystick:lab_demo"
